...
stub" note above was stale and has been removed as of this check. */
    {19,"K","Potassium",     39.098,  0.82, 2.75, 2.03, 2.75,  4.341, 0.501,  1,
      {{{0}}, 0, 0}, 0.035*KCAL_MOL_TO_EV, 3.812 },

    /* Z=20 Ca Calcium */
    {20,"Ca","Calcium",      40.078,  1.00, 2.31, 1.76, 2.31,  6.113, 0.018,  2,
      {{{0}}, 0, 0}, 0.238*KCAL_MOL_TO_EV, 3.399 },
    /* Z=21..36 (Sc → Kr): fully populated entries */
    {21,"Sc","Scandium",     44.956,  1.36, 2.11, 1.70, 2.11,  6.561, 0.188,  3, {{{0}}, 0, 0}, 0.019*KCAL_MOL_TO_EV, 3.295},
    {22,"Ti","Titanium",     47.867,  1.54, 2.00, 1.60, 2.00,  6.828, 0.079,  4, {{{0}}, 0, 0}, 0.017*KCAL_MOL_TO_EV, 3.175},
    {23,"V","Vanadium",      50.942,  1.63, 1.92, 1.53, 1.92,  6.746, 0.525,  5, {{{0}}, 0, 0}, 0.016*KCAL_MOL_TO_EV, 3.144},
    {24,"Cr","Chromium",     51.996,  1.66, 1.85, 1.39, 1.85,  6.767, 0.666,  3, {{{0}}, 0, 0}, 0.015*KCAL_MOL_TO_EV, 3.023},
    {25,"Mn","Manganese",    54.938,  1.55, 1.79, 1.61, 1.79,  7.434, 0.000,  2, {{{0}}, 0, 0}, 0.013*KCAL_MOL_TO_EV, 2.961},
    {26,"Fe","Iron",         55.845,  1.83, 1.72, 1.52, 1.72,  7.902, 0.151,  3, {{{0}}, 0, 0}, 0.013*KCAL_MOL_TO_EV, 2.912},
    {27,"Co","Cobalt",       58.933,  1.88, 1.67, 1.50, 1.67,  7.881, 0.662,  3, {{{0}}, 0, 0}, 0.014*KCAL_MOL_TO_EV, 2.872},
    {28,"Ni","Nickel",       58.693,  1.91, 1.63, 1.24, 1.63,  7.640, 1.156,  2, {{{0}}, 0, 0}, 0.015*KCAL_MOL_TO_EV, 2.834},
    {29,"Cu","Copper",       63.546,  1.90, 1.40, 1.32, 1.40,  7.726, 1.235,  2, {{{0}}, 0, 0}, 0.005*KCAL_MOL_TO_EV, 3.495},
    {30,"Zn","Zinc",         65.38,   1.65, 1.39, 1.22, 1.39,  9.394, 0.000,  2, {{{0}}, 0, 0}, 0.124*KCAL_MOL_TO_EV, 2.763},
    {31,"Ga","Gallium",      69.723,  1.81, 1.87, 1.22, 1.87,  5.999, 0.300,  3, {{{0}}, 0, 0}, 0.415*KCAL_MOL_TO_EV, 4.383},
    {32,"Ge","Germanium",    72.630,  2.01, 2.11, 1.20, 2.11,  7.900, 1.233,  4, {{{0}}, 0, 0}, 0.379*KCAL_MOL_TO_EV, 4.280},
    {33,"As","Arsenic",      74.922,  2.18, 1.85, 1.19, 1.85,  9.815, 0.814,  3, {{{0}}, 0, 0}, 0.309*KCAL_MOL_TO_EV, 4.230},
    {34,"Se","Selenium",     78.971,  2.55, 1.90, 1.20, 1.90,  9.752, 2.021,  2, {{{0}}, 0, 0}, 0.291*KCAL_MOL_TO_EV, 4.205},
    {35,"Br","Bromine",      79.904,  2.96, 1.85, 1.20, 1.85, 11.814, 3.365,  1, {{{0}}, 0, 0}, 0.251*KCAL_MOL_TO_EV, 4.189},
    {36,"Kr","Krypton",      83.798, -1.00, 2.02, 1.16, 2.02, 14.000, 0.000,  0, {{{0}}, 0, 0}, 0.220*KCAL_MOL_TO_EV, 4.141},
};
