...
/*
 * Add an explicit dihedral (torsion) between 4 sequential atoms
 * a-b-c-d, with the standard AMBER/CHARMM functional form
 * V = k*(1+cos(n*phi-delta)). Returns the dihedral index, or
 * SIM_ERR_OVERFLOW if capacity is exceeded.
 */
